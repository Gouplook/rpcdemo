...
@Time : 2021/1/18 09:29
@Description: ormlog 操作日志log
...
// NewLog set io.Writer to create a Logger.(创建一个记录器）
func NewLog(out io.Writer) *Log {
	d := new(Log)
	d.Logger = log.New(out, "[ORM]",log.LstdFlags)  // initial values for the standard logger
	return d
}
